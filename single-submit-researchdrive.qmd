...
- the user will log in to submit server and execute the condor_submit command on the `analysis.sub` file. The purpose of this pipeline is to do the heavy lifting of containerizing the analysis, build the files required by CHTC, and move them to the user's `/home` directory.
...
scp analysis.R analysis.sub analysis.sh data.csv lares@ap2001.chtc.wisc.edu:/home/lares

```


### Data from ResearchDrive

SSH into CHTC

Run `smbclient -k //research.drive.wisc.edu/lares`
